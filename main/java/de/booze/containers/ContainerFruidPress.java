...
public class ContainerFruidPress extends ContainerBoozeBase implements ISlotValidator {
	
	TileFruidPress myTile;

	public ContainerFruidPress(InventoryPlayer paramInventoryPlayer, TileEntity paramTileEntity)
	{
		super(paramInventoryPlayer, paramTileEntity);
		this.myTile = ((TileFruidPress)paramTileEntity);
